  ...
  <view class="my-coach-container">
    ...
    <view class="hall-tabs">
      <view class="tab-item" v-if="studentContext.schoolId" :class="{ 'active': currentTab === 'current' }"
        @click="currentTab = 'current'">驾校教练</view>

      <view class="tab-item" :class="{ 'active': currentTab === 'historySchool' }"
        @click="currentTab = 'historySchool'">历史带教</view>
      <view class="tab-item" :class="{ 'active': currentTab === 'independent' }" @click="currentTab = 'independent'">
        独立私教</view>
    </view>
