      ...
      <view v-if="currentStep === 2" class="step-content">
        ...
        <scroll-view scroll-y class="list-scroll">
          <view 
            ...
            :key="school.id"
            class="list-item"
            :class="{ selected: form.schoolId === school.id }"
      ...
      <view v-if="currentStep === 3" class="step-content">
        ...
        <scroll-view scroll-y class="list-scroll">
          <view 
            ...
            :key="coach.id"
            class="coach-card"
            :class="{ selected: form.mainCoachId === coach.id }"
            @click="form.mainCoachId = coach.id"
          >
...
const licenses = ref([
  ...
  { id: '2', code: 'C2', name: '小型汽车手动挡', },
  { id: '3', code: 'C3', name: '小型汽车手动挡', },
...
.card-select {
  ...
  .card-icon { font-size: 60rpx; display: block; margin-bottom: 20rpx; }
  .card-text { font-size: 30rpx; font-weight: 500; }
}
...
.list-item, .coach-card {
  ...
  &.selected { border-color: #2979ff; background: #f0f7ff; }
}

.coach-card {
  .avatar { width: 100rpx; height: 100rpx; border-radius: 50%; margin-right: 20rpx; }
  .coach-info { flex: 1; }
  .coach-name { font-size: 32rpx; font-weight: bold; }
  .tag { font-size: 20rpx; background: #ff9900; color: #fff; padding: 2rpx 8rpx; border-radius: 4rpx; margin-left: 10rpx; }
  .coach-rate { font-size: 24rpx; color: #666; margin-top: 8rpx; }
  .select-btn {
    font-size: 24rpx;
    background: #f0f0f0;
    color: #333;
